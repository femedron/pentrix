    ...
    private static Point[] getPoints(int seed, int brickCount){
        if(brickCount == 4){
            ...
            switch (seed) {
                // 1 block
                case 1:
                    return new Point[]{new Point(3, 1), new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(3, 5)};
...
//            case 4: return new Point[]{new Point(1,3), new Point(1,2), new Point(1,3), new Point(1,4), new Point(1,5)};
                ...
                // 2 block 1v
                case 2:
                    return new Point[]{new Point(3, 2), new Point(4, 3), new Point(3, 3), new Point(2, 3), new Point(2, 4)};
...
//            case 8: return new Point[]{new Point(2,3),new Point(3,2),new Point(3,3),new Point(3,4),new Point(4,4)};
                ...
                // 2 block 2v
                case 3:
                    return new Point[]{new Point(3, 2), new Point(4, 2), new Point(2, 3), new Point(3, 3), new Point(3, 4)};
...
//            case 15: return new Point[]{new Point(1,3),new Point(1,4),new Point(2,3), new Point(3,3), new Point(4,3)};
                case 4:
                    return new Point[]{new Point(2, 2), new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(3, 5)};
...
//            case 19: return new Point[]{new Point(1,3),new Point(1,2),new Point(2,3), new Point(3,3), new Point(4,3)};
                case 5:
                    return new Point[]{new Point(4, 2), new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(3, 5)};
...
//            case 23: return new Point[]{new Point(2,2),new Point(3,2),new Point(4,2), new Point(3,3), new Point(4,3)};
                case 6:
                    return new Point[]{new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(2, 3), new Point(2, 4)};
...
//            case 27: return new Point[]{new Point(2,3),new Point(3,3),new Point(4,3), new Point(3,2), new Point(4,2)};
                case 7:
                    return new Point[]{new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(4, 3), new Point(4, 4)};
...
//            case 31: return new Point[]{new Point(1,4),new Point(2,4),new Point(2,3), new Point(3,3), new Point(4,3)};
                case 8:
                    return new Point[]{new Point(2, 2), new Point(2, 3), new Point(3, 3), new Point(3, 4), new Point(3, 5)};
...
//            case 35: return new Point[]{new Point(1,2),new Point(2,2),new Point(2,3), new Point(3,3), new Point(3,4)};
                case 9:
                    return new Point[]{new Point(4, 2), new Point(4, 3), new Point(3, 3), new Point(3, 4), new Point(3, 5)};
...
//            case 39: return new Point[]{new Point(3,2), new Point(3,3),new Point(3,4),new Point(2,3),new Point(1,3)};
                case 10:
                    return new Point[]{new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(2, 4), new Point(4, 4)};


                // 7 block
                case 11:
                    return new Point[]{new Point(3, 2), new Point(2, 2), new Point(3, 3), new Point(3, 4), new Point(2, 4)};
...
//            case 47: return new Point[]{new Point(5,2),new Point(4,2),new Point(3,2),new Point(3,3),new Point(3,4)};
                case 12:
                    return new Point[]{new Point(1, 2), new Point(2, 2), new Point(3, 2), new Point(3, 3), new Point(3, 4)};
...
//            case 51: return new Point[]{new Point(4,2),new Point(3,2),new Point(3,3),new Point(2,3),new Point(2,4)};
                case 13:
                    return new Point[]{new Point(2, 2), new Point(3, 2), new Point(3, 3), new Point(4, 3), new Point(4, 4)};
...
//            case 55: return new Point[]{new Point(3,2),new Point(3,3),new Point(3,4),new Point(2,3),new Point(4,3)};
                case 14:
                    return new Point[]{new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(2, 3), new Point(4, 3)};
...
//            case 59: return new Point[]{new Point(1,3),new Point(2,3),new Point(3,3),new Point(3,4),new Point(4,3)};
                case 15:
                    return new Point[]{new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(3, 5), new Point(2, 4)};
...
//            case 63: return new Point[]{new Point(1,3),new Point(2,3),new Point(3,3),new Point(3,2),new Point(4,3)};
                case 16:
                    return new Point[]{new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(3, 5), new Point(4, 4)};
...
//            case 67: return new Point[]{new Point(2,3),new Point(2,4),new Point(3,3),new Point(4,2),new Point(4,3)};
                case 17:
                    return new Point[]{new Point(2, 2), new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(4, 4)};
...
//            case 71: return new Point[]{new Point(2,2),new Point(2,3),new Point(3,3),new Point(4,3),new Point(4,4)};
                case 18:
                    return new Point[]{new Point(4, 2), new Point(3, 2), new Point(3, 3), new Point(3, 4), new Point(2, 4)};
