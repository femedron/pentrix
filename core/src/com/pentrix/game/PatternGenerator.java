...
public class PatternGenerator {
    ...
    private static Point[] getPoints(int seed){
        switch (seed){
            ...
            // 2 block 1v
            case 5: return new Point[]{new Point(3,2),new Point(4,3),new Point(3,3),new Point(2,3),new Point(2,4)};
            ...
            // 2 block 2v
            case 9: return new Point[]{new Point(3,2),new Point(4,2),new Point(2,3),new Point(3,3),new Point(3,4)};
            ...
            case 16: return new Point[]{new Point(2,1),new Point(3,1),new Point(3,2), new Point(3,3), new Point(3,4)};
            ...
            case 20: return new Point[]{new Point(4,1),new Point(3,1),new Point(3,2), new Point(3,3), new Point(3,4)};
            ...
            case 24: return new Point[]{new Point(3,2),new Point(3,3),new Point(3,4), new Point(2,3), new Point(2,4)};
            ...
            case 28: return new Point[]{new Point(3,2),new Point(3,3),new Point(3,4), new Point(4,3), new Point(4,4)};
            ...
            case 32: return new Point[]{new Point(2,1),new Point(2,2),new Point(3,2), new Point(3,3), new Point(3,4)};
            ...
            case 36: return new Point[]{new Point(4,1),new Point(4,2),new Point(3,2), new Point(3,3), new Point(3,4)};
            ...
            case 40: return new Point[]{new Point(3,1),new Point(3,2),new Point(3,3),new Point(2,3),new Point(4,3)};


            // 7 block
            case 41: return new Point[]{new Point(3,2),new Point(2,2),new Point(3,3),new Point(3,4),new Point(2,4)};
            ...
            case 48: return new Point[]{new Point(1,2),new Point(2,2),new Point(3,2),new Point(3,3),new Point(3,4)};
            ...
            case 52: return new Point[]{new Point(2,2),new Point(3,2),new Point(3,3),new Point(4,3),new Point(4,4)};
            ...
            case 56: return new Point[]{new Point(3,2),new Point(3,3),new Point(3,4),new Point(2,3),new Point(4,3)};
            ...
            case 60: return new Point[]{new Point(3,1),new Point(3,2),new Point(3,3),new Point(3,4),new Point(2,3)};
            ...
            case 64: return new Point[]{new Point(3,1),new Point(3,2),new Point(3,3),new Point(3,4),new Point(4,3)};
            ...
            case 68: return new Point[]{new Point(2,2),new Point(3,2),new Point(3,3),new Point(3,4),new Point(4,4)};
            ...
            case 72: return new Point[]{new Point(4,2),new Point(3,2),new Point(3,3),new Point(3,4),new Point(2,4)};
